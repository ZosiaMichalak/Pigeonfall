    ...
    return {
        {
            "Corridor", 0,
            {
                { EnemyType::BULLET, {200.f, 100.f}, 0 },
                { EnemyType::BULLET, {300.f, 80.f},  0 },
            },
            {
                { PropDef::Type::TRASH,   {50.f,  150.f} },
                { PropDef::Type::VENDING, {320.f, 140.f} },
            }
        },
        {
            "Ambush", 1,
            {
                { EnemyType::DASH,   {150.f, 80.f},  1 },
                { EnemyType::BULLET, {250.f, 120.f}, 0 },
                { EnemyType::DASH,   {330.f, 60.f},  1 },
            },
            {
                { PropDef::Type::TRASH, {80.f,  160.f} },
                { PropDef::Type::TRASH, {200.f, 155.f} },
            }
        },
        {
            "Showdown", 2,
            {
                { EnemyType::BULLET, {180.f, 90.f},  1 },
                { EnemyType::BULLET, {280.f, 110.f}, 1 },
                { EnemyType::DASH,   {230.f, 60.f},  2 },
            },
            {
                { PropDef::Type::VENDING, {60.f,  140.f} },
                { PropDef::Type::VENDING, {300.f, 145.f} },
            }
        },
        {
            "Gauntlet", 0,
            {
                { EnemyType::BULLET, {120.f, 70.f},  0 },
                { EnemyType::BULLET, {200.f, 130.f}, 0 },
                { EnemyType::BULLET, {300.f, 90.f},  0 },
                { EnemyType::DASH,   {260.f, 60.f},  1 },
            },
            {
        ...
        },
        {
            "Crossfire", 1,
            {
                { EnemyType::BULLET, {100.f, 100.f}, 1 },
                { EnemyType::DASH,   {320.f, 100.f}, 1 },
            },
            {
                { PropDef::Type::TRASH,   {180.f, 150.f} },
                { PropDef::Type::VENDING, {240.f, 145.f} },
            }
        },
    };
}
